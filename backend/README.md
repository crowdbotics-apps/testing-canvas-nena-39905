...
## Project Structure
    ...
    ├── testing_canvas_nena_39905  # Django project configurations
...
1. Clone this repo and `cd testing_canvas_nena_39905`
...
2. Clone this repo and `cd testing_canvas_nena_39905`
